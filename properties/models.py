...
class Property(models.Model):
    ...
    object_description = models.CharField(
        max_length=1800, blank=True, null=True, verbose_name="Objektbeschreibung")
    equipment_description = models.CharField(
        max_length=1800,blank=True, null=True, verbose_name="Beschreibung der Ausstattung")
    location_description = models.CharField(
        max_length=1800,blank=True, null=True, verbose_name="Lagebeschreibung")
    other_description = models.CharField(
       max_length=1800, blank=True, null=True, verbose_name="Sonstige Beschreibung")
