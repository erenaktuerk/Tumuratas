...
"""
this mail function is a notification to tumuratas group, when someone has sended an form.
...
def send_mail_to_tumuratas(whichform, firstname, lastname, email, customerMessage=None, tel=None, market_plan=None, total_size=None, street=None, building_year=None, ground_size=None, living_size=None, housenumber=None, postialcode=None, city=None, objecttype=None, country=None, notification=None):
...
def send_contact_mail(whichform, firstname, lastname, email, customerMessage=None, tel=None, city=None, street=None, topic=None, postialcode=None):
    # we enter the data that the form includes
    context = {
        'whichform': whichform,
        'firstname': firstname,
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if contactform.is_valid():
            ...
            send_contact_mail(
                'Kontaktformular', request.POST['firstname'], request.POST['lastname'], request.POST['email'], request.POST['message'], request.POST['tel'], request.POST['city'], request.POST['street'], request.POST['topic'], postialcode=request.POST['postialcode'])
